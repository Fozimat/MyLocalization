package com.fozimat.mylocalization
...
import com.fozimat.mylocalization.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val pokeCount = 3
        val hello = resources.getString(R.string.hello_world, "Fozimat Amhas", pokeCount, "Ari Ginting")
